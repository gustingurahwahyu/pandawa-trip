        ...
        @forelse ($destinasis as $destinasi)
            <a href="#" data-modal-target="default-modal" data-modal-toggle="default-modal" class="block">
                <div
                    ...
                    <div class="flex w-full image-container h-7/12">
                    ...
                    <div class="flex flex-col p-2 bg-white rounded-md card-detail h-5/12 md:p-4 md:rounded-card">
                        <p class="text-lg font-semibold md:text-xl lg:text-2xl text-secondary">
                            {{ $destinasi->name }}
                        </p>
                        ...
                        <p
                            class="mt-2 text-xs text-graytext md:text-sm lg:text-base line-clamp-2 md:line-clamp-3 lg:line-clamp-4">
