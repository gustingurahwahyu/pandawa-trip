...
<div class="container px-8 py-10 lg:py-20 mx-auto bg-softgray">
  <!-- CSS Fixes -->
  <style>
  ...
  <div class="flex flex-col md:flex-row justify-between mx-auto items-center">
    <h2 class="w-full lg:w-6/12 text-2xl md:pr-60 text-center lg:pr-0 lg:text-4xl/[60px] md:text-start font-bold text-secondary mb-6 md:mb-0">Tempat Keren yang
      <span class="text-primary">Wajib Kamu</span> Kunjungi
    </h2>
    <div class="flex space-x-2">
      <button id="prev-arrow" class="splide__arrow--prev flex w-8 lg:w-10 h-8 lg:h-10 items-center justify-center rounded-full hover:opacity-80 transition">
        <img class="w-[20px] lg:w-[24px]" src="image/icon/arrow-left.svg" alt="arrow left">
      </button>
      <button id="next-arrow" class="splide__arrow--next flex w-8 lg:w-10 h-8 lg:h-10 items-center justify-center rounded-full hover:opacity-80 transition">
        <img class="w-[20px] lg:w-[24px]" src="image/icon/arrow-right.svg" alt="arrow right">
      </button>
    </div>
  </div>

  <div id="destination-splide" class="splide mt-8 overflow-hidden" aria-label="Destinasi Terbaik">
    <div class="splide__track orverflow-hidden">
      <ul class="splide__list flex">
        <!-- Card 1 -->
        <li class="splide__slide">
          <div class="flex-col justify-center md:w-[21rem] lg:w-[19rem] xl:w-[24rem] h-[27rem] bg-white rounded-card">
            <div class="image-container w-full h-80 bg-white rounded-card overflow-hidden">
              <img class="w-full h-full object-cover" src="image/monkey-forest.jpg" alt="paket ubud">
            </div>
            <div class="flex-col space-y-3 p-5">
              <p class="text-2xl font-semibold text-secondary">Monkey Forest</p>
