<div id="searchbar"
    class="container flex-col px-3 md:px-8 mx-auto py-1.5 md:py-2 xl:py-4 space-y-2 md:space-y-3 xl:space-y-6 z-[10] bg-softgray/0">
    <form class="w-full" method="GET" action="{{ route('destinasi') }}">
