<div id="searchbar"
    ...
    <form class="w-full space-y-2 md:space-y-3" method="GET" action="{{ route('destinasi') }}">
        ...
        <div class="relative">
            ...
            <input type="search" id="default-search" name="search" value="{{ request('search') }}"
                ...
                placeholder="Temukan Destinasi Wisata Impianmu" required />
        ...
        <div class="relative inline-block">
            <button id="dropdownDefaultButton" type="button"
                class="flex items-center px-2 py-1 text-xs bg-transparent border rounded-full border-graytext md:text-sm text-graytext md:py-1.5 md:px-3 hover:brightness-50 ease-out duration-200 transition">
                ...
                <ul class="py-2 text-sm text-graytext" aria-labelledby="dropdownDefaultButton">
                    <li>
                        <button type="button"
                            ...
                            <p class="flex items-center">Nama Destinasi</p>
                        </button>
                    </li>
                    <li>
                        <button type="button"
