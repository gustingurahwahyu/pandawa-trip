<div class="container flex-col px-8 mx-auto my-4 space-y-6">
    <form class="w-full">
        ...
        <div class="relative">
            ...
            <input type="search" id="default-search" class="block w-full px-4 py-6 ps-16 text-xl outline-none text-gray-900 rounded-card drop-shadow-md" placeholder="Temukan Destinasi Wisata Impianmu " required />
    ...
    <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44">
        <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownDefaultButton">
            <li>
                <a href="#" class="block px-4 py-2 hover:bg-gray-100">Nama Destinasi</a>
            </li>
            <li>
