<div id="searchbar" class="container flex-col px-3 md:px-8 mx-auto py-1.5 md:py-2 xl:py-4 space-y-2 md:space-y-3 xl:space-y-6 z-[999] bg-softgray/0">
  <form class="w-full">
    ...
    <div class="relative">
      ...
      <input type="search" id="default-search" class="block w-full px-3.5 md:px-4 py-3.5 md:py-6 ps-10 md:ps-16 text-xs md:text-base lg:text-lg xl:text-xl outline-none text-gray-900 rounded-card drop-shadow-md" placeholder="Temukan Paket Ideal Untuk Liburanmu" required />
